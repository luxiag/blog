import{S as Q,V as X,P as Y,a as ss,D as ns,M as as,b as ls,W as es,T as os,C as ps}from"./three.module-DElcEsb7.js";import{O as z}from"./OrbitControls-COOjmuLA.js";import{_ as ts,i as a,l as H,c as rs,a as l,d as e,o as Fs}from"./app-xakek6kx.js";const cs={__name:"glsl-graphical-part2.html",setup(J,{expose:s}){s();const n=r=>{const F=new Q,$=new ps,p={u_time:{type:"f",value:1},uTime:{type:"f",value:1},u_resolution:{type:"v2",value:new X}},t=new Y(75,2,.1,1e3);t.position.set(0,0,10),F.add(t);const I=new ss({uniforms:p,fragmentShader:r.fragmentShader,vertexShader:`
