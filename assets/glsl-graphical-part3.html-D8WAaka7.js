import{l as Q,a as X,m as Y,n as ss,o as ns,p as as,q as ls,W as os,r as ps,s as es}from"./three.module-_5Kft3IB.js";import{O as N}from"./OrbitControls-86TszHm5.js";import{_ as Fs,e as cs,f as l,g as o,r as a,i as V,o as rs}from"./app-Bd-A8UqK.js";const ts={__name:"glsl-graphical-part3.html",setup(H,{expose:s}){s();const n=c=>{const r=new Q,W=new es,e={u_time:{type:"f",value:1},uTime:{type:"f",value:1},u_resolution:{type:"v2",value:new X}},F=new Y(75,2,.1,1e3);F.position.set(0,0,10),r.add(F);const J=new ss({uniforms:e,fragmentShader:c.fragmentShader,vertexShader:`
