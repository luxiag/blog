import{l as Q,b as X,m as Y,n as ss,o as ns,p as as,q as ls,W as es,r as os,s as ps}from"./three.module-DS1BwEFu.js";import{O as z}from"./OrbitControls-DPkMXWBp.js";import{_ as ts,h as a,i as H,c as rs,a as l,b as e,o as Fs}from"./app-DADNOUiR.js";const cs={__name:"glsl-graphical-part2.html",setup(J,{expose:s}){s();const n=r=>{const F=new Q,j=new ps,p={u_time:{type:"f",value:1},uTime:{type:"f",value:1},u_resolution:{type:"v2",value:new X}},t=new Y(75,2,.1,1e3);t.position.set(0,0,10),F.add(t);const I=new ss({uniforms:p,fragmentShader:r.fragmentShader,vertexShader:`
