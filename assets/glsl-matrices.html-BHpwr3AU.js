...
void main(){
    ...
    `},D=y(),g={shaderDom:D,fragmentShader:`
#ifdef GL_ES
precision mediump float;
#endif
...
void main(  )
{
    ...
    `};G(()=>{c(b),c(_),c(g),C(z)});const S={initScene:c,initShaderToy:C,translationRef:B,translationShader:b,rotateRef:A,rotateShader:_,scaleRef:D,scaleShader:g,radarRef:x,radarShader:z,ref:y,onMounted:G,get THREE(){return j},get OrbitControls(){return h}};return Object.defineProperty(S,"__isScriptSetup",{enumerable:!1,value:!0}),S}},K={ref:"translationRef"},ss={ref:"rotateRef"},ns={ref:"scaleRef"},as={ref:"radarRef"};function ls(I,l,c,C,B,b){return Y(),Z("div",null,[l[0]||(l[0]=u('<h2 id="平移" tabindex="-1"><a class="header-anchor" href="#平移"><span>平移</span></a></h2><figure><img src="'+$+`" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure><div class="language-glsl line-numbers-mode" data-highlighter="shiki" data-ext="glsl" data-title="glsl" style="background-color:#282A36;color:#F8F8F2;"><pre class="shiki dracula vp-code"><code><span class="line"><span style="color:#6272A4;">// Author @patriciogv ( patriciogonzalezvivo.com ) - 2015</span></span>
