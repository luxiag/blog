import{_ as pa,h as L,i as q,q as ia,c as da,a as Z,b as S,f as va,o as Fa}from"./app-DsmKNl15.js";import{p as V,V as p,i as z,aj as ba,P as ya,k as G,ay as J,m as N,az as ua,aA as U,aB as $,n as ta,aF as ma,aD as la,l as K,as as ha,o as ga,b as wa,aC as Ca,z as xa,W as X,at as Q,q as Ea,J as Aa,X as Ba,aR as Sa,$ as Da,r as Ma,M as Y,s as Ta}from"./three.module-DS1BwEFu.js";import{O as H}from"./OrbitControls-DPkMXWBp.js";import{R as aa}from"./RGBELoader-CNHXFbsE.js";import{G as sa}from"./GLTFLoader-Ply5ciTv.js";import{W as na}from"./Water2-C-n41k6O.js";class ea extends V{constructor(t,a={}){super(t),this.isWater=!0;const l=this,P=a.textureWidth!==void 0?a.textureWidth:512,b=a.textureHeight!==void 0?a.textureHeight:512,k=a.clipBias!==void 0?a.clipBias:0,j=a.alpha!==void 0?a.alpha:1,n=a.time!==void 0?a.time:0,i=a.waterNormals!==void 0?a.waterNormals:null,A=a.sunDirection!==void 0?a.sunDirection:new p(.70707,.70707,0),D=new z(a.sunColor!==void 0?a.sunColor:16777215),M=new z(a.waterColor!==void 0?a.waterColor:8355711),y=a.eye!==void 0?a.eye:new p(0,0,0),o=a.distortionScale!==void 0?a.distortionScale:20,g=a.side!==void 0?a.side:ba,w=a.fog!==void 0?a.fog:!1,F=new ya,s=new p,d=new p,B=new p,m=new G,h=new p(0,0,-1),r=new J,v=new p,C=new p,x=new J,E=new G,f=new N,_=new ua(P,b),T={name:"MirrorShader",uniforms:U.merge([$.fog,$.lights,{normalSampler:{value:null},mirrorSampler:{value:null},alpha:{value:1},time:{value:0},size:{value:1},distortionScale:{value:20},textureMatrix:{value:new G},sunColor:{value:new z(8355711)},sunDirection:{value:new p(.70707,.70707,0)},eye:{value:new p},waterColor:{value:new z(5592405)}}]),vertexShader:`
