import{S as I,V as K,P as Q,a as ss,D as ns,M as as,b as ls,W as es,T as os,C as ps}from"./three.module-DElcEsb7.js";import{O as j}from"./OrbitControls-COOjmuLA.js";import{_ as ts,i as a,l as N,c as rs,a as l,d as e,o as Fs}from"./app-BcWk5rXQ.js";const cs={__name:"glsl-graphical-part1.html",setup(z,{expose:s}){s();const n=r=>{const F=new I,V=new ps,p={u_time:{type:"f",value:1},uTime:{type:"f",value:1},u_resolution:{type:"v2",value:new K}},t=new Q(75,2,.1,1e3);t.position.set(0,0,10),F.add(t);const H=new ss({uniforms:p,fragmentShader:r.fragmentShader,vertexShader:`
