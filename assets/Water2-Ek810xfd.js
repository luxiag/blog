import{M as j,P as N,m as _,c as O,e as p,n as D,j as U,aX as V,aF as L,a as z,aY as E,Q,V as X,l as G,aZ as Y,a5 as H,C as Z}from"./three.module-DElcEsb7.js";class F extends j{constructor(b,t={}){super(b),this.isReflector=!0,this.type="Reflector",this.camera=new N;const n=this,C=t.color!==void 0?new _(t.color):new _(8355711),W=t.textureWidth||512,R=t.textureHeight||512,S=t.clipBias||0,v=t.shader||F.ReflectorShader,P=t.multisample!==void 0?t.multisample:4,l=new O,x=new p,s=new p,g=new p,y=new D,M=new p(0,0,-1),f=new U,h=new p,w=new p,e=new U,o=new D,r=this.camera,c=new V(W,R,{samples:P,type:L}),u=new z({name:v.name!==void 0?v.name:"unspecified",uniforms:E.clone(v.uniforms),fragmentShader:v.fragmentShader,vertexShader:v.vertexShader});u.uniforms.tDiffuse.value=c.texture,u.uniforms.color.value=C,u.uniforms.textureMatrix.value=o,this.material=u,this.onBeforeRender=function(a,d,i){if(s.setFromMatrixPosition(n.matrixWorld),g.setFromMatrixPosition(i.matrixWorld),y.extractRotation(n.matrixWorld),x.set(0,0,1),x.applyMatrix4(y),h.subVectors(s,g),h.dot(x)>0)return;h.reflect(x).negate(),h.add(s),y.extractRotation(i.matrixWorld),M.set(0,0,-1),M.applyMatrix4(y),M.add(g),w.subVectors(s,M),w.reflect(x).negate(),w.add(s),r.position.copy(h),r.up.set(0,1,0),r.up.applyMatrix4(y),r.up.reflect(x),r.lookAt(w),r.far=i.far,r.updateMatrixWorld(),r.projectionMatrix.copy(i.projectionMatrix),o.set(.5,0,0,.5,0,.5,0,.5,0,0,.5,.5,0,0,0,1),o.multiply(r.projectionMatrix),o.multiply(r.matrixWorldInverse),o.multiply(n.matrixWorld),l.setFromNormalAndCoplanarPoint(x,s),l.applyMatrix4(r.matrixWorldInverse),f.set(l.normal.x,l.normal.y,l.normal.z,l.constant);const m=r.projectionMatrix;e.x=(Math.sign(f.x)+m.elements[8])/m.elements[0],e.y=(Math.sign(f.y)+m.elements[9])/m.elements[5],e.z=-1,e.w=(1+m.elements[10])/m.elements[14],f.multiplyScalar(2/f.dot(e)),m.elements[2]=f.x,m.elements[6]=f.y,m.elements[10]=f.z+1-S,m.elements[14]=f.w,n.visible=!1;const I=a.getRenderTarget(),k=a.xr.enabled,q=a.shadowMap.autoUpdate;a.xr.enabled=!1,a.shadowMap.autoUpdate=!1,a.setRenderTarget(c),a.state.buffers.depth.setMask(!0),a.autoClear===!1&&a.clear(),a.render(d,r),a.xr.enabled=k,a.shadowMap.autoUpdate=q,a.setRenderTarget(I);const A=i.viewport;A!==void 0&&a.state.viewport(A),n.visible=!0},this.getRenderTarget=function(){return c},this.dispose=function(){c.dispose(),n.material.dispose()}}}F.ReflectorShader={name:"ReflectorShader",uniforms:{color:{value:null},tDiffuse:{value:null},textureMatrix:{value:null}},vertexShader:`
