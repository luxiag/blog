import{S as Q,V as X,P as Y,a as ss,D as ns,M as as,b as ls,W as os,T as ps,C as es}from"./three.module-DElcEsb7.js";import{O as j}from"./OrbitControls-COOjmuLA.js";import{_ as Fs,i as a,l as N,c as cs,a as l,d as o,o as rs}from"./app-sHEEJrqx.js";const ts={__name:"glsl-graphical-part3.html",setup(H,{expose:s}){s();const n=c=>{const r=new Q,V=new es,e={u_time:{type:"f",value:1},uTime:{type:"f",value:1},u_resolution:{type:"v2",value:new X}},F=new Y(75,2,.1,1e3);F.position.set(0,0,10),r.add(F);const J=new ss({uniforms:e,fragmentShader:c.fragmentShader,vertexShader:`
