import{S as O,V as $,P as W,a as P,D as z,M as N,b as I,W as U,O as g,c as v,d as q,e as m,f as J,T as Q,C as H}from"./OrbitControls-BJWANvCS.js";import{_ as X,i as c,l as V,c as Y,a as i,d as F,o as K}from"./app-Dlgm_vOi.js";const ss="/assets/894001203041232323-Ch6aHHJ3.png",ns="/assets/453001303041232323-3ybriALr.png",ls={__name:"glsl-shapes.html",setup(Z,{expose:s}){s();const o=n=>{const e=new O,h=new H,t={u_time:{type:"f",value:1},u_resolution:{type:"v2",value:new $(n.shaderDom.value.offsetWidth,n.shaderDom.value.offsetWidth/2)}},a=new W(75,2,.1,1e3);a.position.set(0,0,20),e.add(a);const p=new P({uniforms:t,fragmentShader:n.fragmentShader,side:z}),d=new N(new I(100,100),p);d.position.set(0,0,0),e.add(d);const l=new U;l.setSize(n.shaderDom.value.offsetWidth,n.shaderDom.value.offsetWidth/2),l.shadowMap.enabled=!0,n.shaderDom.value.appendChild(l.domElement),l.render(e,a);const y=new g(a,l.domElement);y.enableDamping=!0,t.u_resolution.value;function u(){t.u_time.value+=h.getDelta(),y.update(),l.render(e,a),requestAnimationFrame(u)}u()},b=n=>{const e=new O,h=new H,t={iResolution:{value:new v},iTime:{value:0},iTimeDelta:{value:0},iFrameRate:{value:60},iFrame:{value:0},iChannelTime:{value:[0,0,0,0]},iChannelResolution:{value:[new v,new v,new v,new v]},iMouse:{value:new q},iChannel0:{value:new m},iChannel1:{value:new m},iChannel2:{value:new m},iChannel3:{value:new m},iDate:{value:new q}},a=new W(75,2,.1,1e3);a.position.set(0,0,20),e.add(a);const p=new P({uniforms:t,vertexShader:`
...
gl_FragColor = vec4((( horBeam)* horColour), 1.0);
    ...
    `},T=c(),w={shaderDom:T,fragmentShader:`
    #ifdef GL_ES
precision mediump float;
# endif
...
void main(){
    ...
    `};V(()=>{o(f),o(_),o(x),b(S),o(w),o(k),o(E)});const G={initScene:o,initShaderToy:b,rectangularRef:C,rectangularShader:f,circleRef:B,circleShader:_,rectangularRef2:A,rectangularShader2:x,circleRef2:D,circleShader2:S,whiteCircleRef:T,whiteCircleShader:w,whiteTriangleRef:R,whiteTriangleShader:k,cloverRef:L,cloverShader:E,ref:c,onMounted:V,get THREE(){return Q},get OrbitControls(){return g}};return Object.defineProperty(G,"__isScriptSetup",{enumerable:!1,value:!0}),G}},as={ref:"rectangularRef"},es={ref:"rectangularRef2"},os={ref:"circleRef"},ps={ref:"circleRef2"},cs={ref:"whiteCircleRef"},rs={ref:"whiteTriangleRef"},is={ref:"cloverRef"};function Fs(Z,s,o,b,C,f){return K(),Y("div",null,[s[0]||(s[0]=i(`<p>部分参考： 《OpenGL 编程指南》、《The Book of Shader》</p><h2 id="长方形" tabindex="-1"><a class="header-anchor" href="#长方形"><span>长方形</span></a></h2><div class="language-glsl line-numbers-mode" data-highlighter="shiki" data-ext="glsl" data-title="glsl" style="background-color:#282A36;color:#F8F8F2;"><pre class="shiki dracula vp-code"><code><span class="line"><span style="color:#6272A4;">// Author @patriciogv - 2015</span></span>
