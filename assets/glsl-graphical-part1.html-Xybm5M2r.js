import{l as I,a as K,m as Q,n as ss,o as ns,p as as,q as ls,W as es,r as os,s as ps}from"./three.module-_5Kft3IB.js";import{O as N}from"./OrbitControls-86TszHm5.js";import{_ as ts,e as rs,h as l,f as e,r as a,i as V,o as Fs}from"./app-DPJYBgB6.js";const cs={__name:"glsl-graphical-part1.html",setup(z,{expose:s}){s();const n=r=>{const F=new I,W=new ps,p={u_time:{type:"f",value:1},uTime:{type:"f",value:1},u_resolution:{type:"v2",value:new K}},t=new Q(75,2,.1,1e3);t.position.set(0,0,10),F.add(t);const H=new ss({uniforms:p,fragmentShader:r.fragmentShader,vertexShader:`
