import{l as O,b as $,m as W,n as z,o as P,p as N,q as I,W as U,V as v,aD as q,al as m,J,r as Q,s as H}from"./three.module-BzA_QsZm.js";import{O as g}from"./OrbitControls-DTSS7XTZ.js";import{_ as X,h as c,i as V,c as Y,b as i,d as F,o as K}from"./app-Ogdo9Bdm.js";const ss="/blog/assets/894001203041232323-Ch6aHHJ3.png",ns="/blog/assets/453001303041232323-3ybriALr.png",ls={__name:"glsl-shapes.html",setup(Z,{expose:s}){s();const o=n=>{const e=new O,h=new H,t={u_time:{type:"f",value:1},u_resolution:{type:"v2",value:new $(n.shaderDom.value.offsetWidth,n.shaderDom.value.offsetWidth/2)}},a=new W(75,2,.1,1e3);a.position.set(0,0,20),e.add(a);const p=new z({uniforms:t,fragmentShader:n.fragmentShader,side:P}),d=new N(new I(100,100),p);d.position.set(0,0,0),e.add(d);const l=new U;l.setSize(n.shaderDom.value.offsetWidth,n.shaderDom.value.offsetWidth/2),l.shadowMap.enabled=!0,n.shaderDom.value.appendChild(l.domElement),l.render(e,a);const y=new g(a,l.domElement);y.enableDamping=!0,t.u_resolution.value;function u(){t.u_time.value+=h.getDelta(),y.update(),l.render(e,a),requestAnimationFrame(u)}u()},b=n=>{const e=new O,h=new H,t={iResolution:{value:new v},iTime:{value:0},iTimeDelta:{value:0},iFrameRate:{value:60},iFrame:{value:0},iChannelTime:{value:[0,0,0,0]},iChannelResolution:{value:[new v,new v,new v,new v]},iMouse:{value:new q},iChannel0:{value:new m},iChannel1:{value:new m},iChannel2:{value:new m},iChannel3:{value:new m},iDate:{value:new q}},a=new W(75,2,.1,1e3);a.position.set(0,0,20),e.add(a);const p=new z({uniforms:t,vertexShader:`
