import{l as I,b as K,m as Q,n as ss,o as ns,p as as,q as ls,W as es,r as os,s as ps}from"./three.module-DS1BwEFu.js";import{O as N}from"./OrbitControls-DPkMXWBp.js";import{_ as ts,h as a,i as V,c as rs,a as l,b as e,o as Fs}from"./app-DADNOUiR.js";const cs={__name:"glsl-graphical-part1.html",setup(z,{expose:s}){s();const n=r=>{const F=new I,W=new ps,p={u_time:{type:"f",value:1},uTime:{type:"f",value:1},u_resolution:{type:"v2",value:new K}},t=new Q(75,2,.1,1e3);t.position.set(0,0,10),F.add(t);const H=new ss({uniforms:p,fragmentShader:r.fragmentShader,vertexShader:`
