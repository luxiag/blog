import{l as Q,b as X,m as Y,n as ss,o as ns,p as as,q as ls,W as os,r as ps,s as es}from"./three.module-BzA_QsZm.js";import{O as N}from"./OrbitControls-DTSS7XTZ.js";import{_ as Fs,h as a,i as V,c as cs,b as l,d as o,o as rs}from"./app-BupRR3ON.js";const ts={__name:"glsl-graphical-part3.html",setup(H,{expose:s}){s();const n=c=>{const r=new Q,W=new es,e={u_time:{type:"f",value:1},uTime:{type:"f",value:1},u_resolution:{type:"v2",value:new X}},F=new Y(75,2,.1,1e3);F.position.set(0,0,10),r.add(F);const J=new ss({uniforms:e,fragmentShader:c.fragmentShader,vertexShader:`
