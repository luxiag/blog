---
title: 'FastAPI / Pydantic v2 生产级认证授权：JWT、Refresh Rotation、RBAC 与资源隔离'
date: '2026-08-18'
excerpt: '从威胁模型与信任边界出发，使用 FastAPI、Pydantic v2、SQLAlchemy 2.x、Argon2id、短期 JWT 与可撤销的 refresh token family，构建默认拒绝、可轮换、可审计的生产级认证授权体系。'
